...
export const SearchableMultiSelect = React.forwardRef<HTMLDivElement, SearchableMultiSelectProps>(
  ({ options = [], value, onChange, placeholder = 'Search & select...', searchPlaceholder = 'Search...', className }, ref) => {
